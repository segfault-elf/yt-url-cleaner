...
# How
It uses a single service worker in the background. Nothing too fancy or interesting here, but it's functional I guess. I built this in half an hour sooooo
